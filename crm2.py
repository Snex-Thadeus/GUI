...
def edit_customer():
    ...
    def update():
        ...
        input = (first_name, last_name, zipcode, price_paid, email, address_1, address_2, city, state, country, phone,
    ...
    def edit_now(id, index):
        ...
        payment_method_label = Label(edit_customers, text="Payment Method").grid(row=index + 11, column=0, sticky=W,
                                                                                 padx=10)
        discount_code_label = Label(edit_customers, text="Discount Code").grid(row=index + 12, column=0, sticky=W,
                                                                               padx=10)
