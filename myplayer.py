...
root = Tk()
root.title('TOL MP3 Player(Snex-Tech Systems!)')
...
def add_many_songs():
    songs = filedialog.askopenfilenames(initialdir='C:/', title="Choose A Song", filetypes=(("mp3 Files", "*.mp3"),))
...
# Create Playlist Box
song_box = Listbox(master_frame, bg="black", fg="orange", width=60, selectbackground="green", selectforeground="white")
