...
def search_customer():
   ...
   # search_customers.iconbitmap('c:/gui/codemy.ico')
    ...
    def edit_now(id, index):
        ...
        payment_method_label = Label(search_customers, text="Payment Method").grid(row=index + 11, column=0, sticky=W,
                                                                                   padx=10)
        discount_code_label = Label(search_customers, text="Discount Code").grid(row=index + 12, column=0, sticky=W,
                                                                                 padx=10)
